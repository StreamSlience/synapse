 ...
 * reliably crashes Synapse with `Fatal process out of memory: Zone`
...
/**
 * Build the bordered banner shown when Synapse detects an
 ...
 * package.json. Below this, Synapse relies on language features / native APIs
...
/**
 * Build the bordered banner shown when Synapse detects a Node.js major below
