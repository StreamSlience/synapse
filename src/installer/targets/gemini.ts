 ...
 *     `mcpServers.synapse` key. Same shape as Claude / Cursor.
...
class GeminiTarget implements AgentTarget {
  ...
  install(loc: Location, _opts: InstallOptions): WriteResult {
    ...
    // GEMINI.md gets the short marker-fenced Synapse block (#704):
...
/**
 * Strip the marker-delimited Synapse block from GEMINI.md if a prior
